...
public class ConsoleManager {
    ...
    public ConsoleManager(CommandManager commandManager, Scanner scanner, DatagramChannel datagramChannel, InetSocketAddress serverAddress) {
        ...
        try {
            while (true) {
                ...
                try {
                    ...
                    sendMessage(datagramChannel, input, serverAddress);
