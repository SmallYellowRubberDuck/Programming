...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try {
            InetSocketAddress address = new InetSocketAddress("localhost", 65000+i);
        ...
        ConsoleManager consoleManager = new ConsoleManager(commandManager, scanner, datagramChannel, serverAddress);
